...
class ZhinaoOpenAITextEmbeddingModel(_CommonOpenAI, TextEmbeddingModel):
    """
    ...
    def _invoke(
        ...
        import os
        encoding_format = os.environ.get("OPENAI_RESPONSE_EMBEDDING_TEXT_FORMAT")
        if encoding_format:
            extra_model_kwargs['encoding_format'] = encoding_format
        extra_model_kwargs['encoding_format'] = 'plain' if not encoding_format else 'base64'
